...
int main(int argc, char* argv[]) {
	    ...
	    if(type==1){
	     ...
	     // 	cout<<count<<endl;
	 		...
	 		while(topNTags--){
	 			...
	 			outfile << "Min : " << fib.getMin() <<endl;
	 			cout  << "Min : " << fib.getMin() <<endl;
	 			// outfile<<"----------"<<endl;
	...
	// FibHeap fib;
	// // string test = "test";
	// fib.insertNode(5, "five");
	// fib.deleteMin();
	// cout  << "Min : " << fib.getMin() << '\n';
	// fib.insertNode(5, "five");
	// fib.insertNode(10, "ten");
	// fib.insertNode(2, "two");
	// fib.insertNode(1,"one");
	// fib.insertNode(8, "eight");
	// fib.insertNode(7,"seven");
	// cout  << "Min : " << fib.getMin() << '\n';
	// fib.deleteMin();
	// cout  << "Min : " << fib.getMin() << '\n';
	// fib.decreaseKey(8,4);
